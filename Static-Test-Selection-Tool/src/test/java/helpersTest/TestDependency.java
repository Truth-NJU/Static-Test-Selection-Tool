...
public class TestDependency {
    ...
    public void testDepencyByTest(){
        ...
        // 获得jdeps的输出
        List<String> arg = new ArrayList<>(Arrays.asList("-v", "/Users/taozehua/Downloads/大三上学习资料/自动化测试/工具实现/test/test04/out/artifacts/untitled2_jar"));
        Map<String, Set<String>> depMap = LoadAndStartJdeps.runJdeps(arg);
        Map<String, Set<String>> resMap= computeDepency.testTotypeDependency("main",depMap);
    ...
    public void testTypeTotestDependency(){
        ...
        String rootPath="/Users/taozehua/Downloads/大三上学习资料/自动化测试/工具实现/test/test04";
