...
public class TestDependency {
    ...
    public void testDepencyByTest(){
        ...
        Map<String, Set<String>> resMap= computeDepency.testTotypeDependency("Clazz.Man",depMap);
    ...
    public void testTypeTotestDependency(){
        ...
        String rootPath="/Users/taozehua/Downloads/大三上学习资料/自动化测试/工具实现/test/test01/";
